...
class LoginNotifier extends StateNotifier<LoginState> {
  ...
  Future<void> login(String email, String password) async {
    ...
    try {
      ...
      state =
          LoginState(isLoading: false, error: 'An unexpected error occurred.');
    }
  }
}
...
final productsProvider = StreamProvider.autoDispose
    .family<List<Product>, String>((ref, collectionName) {
  final firebaseService = ref.read(firebaseServiceProvider);
  return firebaseService.fetchPerCollection(collectionName);
});

final productsCombinedProvider =
    StreamProvider.family<List<Product>, List<String>>((ref, collectionNames) {
...
final currentScreenProvider =
    StateProvider<AdminPanelScreen>((ref) => AdminPanelScreen.welcome);
