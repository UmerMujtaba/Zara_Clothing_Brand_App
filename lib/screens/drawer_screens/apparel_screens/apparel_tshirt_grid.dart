...
class ApparelTshirtGridPage  extends StatelessWidget {
  const ApparelTshirtGridPage ({super.key});
          ...
          children: [
            ...
            SizedBox(
              height: MediaQuery.of(context)
                  .size
                  .height, // Ensure grid takes up available space
              child: ProductGrid(products: TshirtProducts,),
            ),
          ],
        ),
      ),
